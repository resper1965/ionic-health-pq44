...
const fullLifecycleFlow = `flowchart TD
    ...
    Phase4_3 --> Phase4_3_1[Gerar MDS2 Form<br/>Automated Script]
    Phase4_3_1 --> Phase4_4[Matriz Rastreabilidade]
    Phase4_4 --> Phase4_5[Certificado Segurança<br/>DefectDojo]
    Phase4_5 --> Phase4_6[QA Leader<br/>Aprovação Digital]
    Phase4_6 --> Phase4_7[SharePoint<br/>DHF + MDS2 PDF Assinado]
