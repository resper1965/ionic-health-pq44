...
#### 3.13 Stage 6: DAST Automatizado (OWASP ZAP)
...
#### 3.18 Monitoramento SIEM Automatizado (Azure Sentinel)
...
#### 3.19 Push to Azure DevOps (Criação Automática de Bug)
...
#### 3.20 Reavaliação Trimestral de Riscos (Automatizada)
